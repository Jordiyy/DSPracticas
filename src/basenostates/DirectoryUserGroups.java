...
public class DirectoryUserGroups {
  ...
  public static void makeUserGroups() throws ParseException {
    ...
    userGroups.get(0).setAreaPermission(area.getSpacesFromArea(),
        new ArrayList<>(List.of("")));
    userGroups.get(1).setAreaPermission(area.getSpacesFromArea(),
        new ArrayList<>(List.of("")));
    userGroups.get(2).setAreaPermission(area.getSpacesFromArea(),
        new ArrayList<>(List.of("parking")));
  }
